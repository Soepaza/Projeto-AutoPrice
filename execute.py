...
def buscar_precos_e_enviar_email():
    ...
    enviar_email('soetestes+1@outlook.com', 'Preços encontrados', 'Confira os preços encontrados nos anexos.', caminho_arquivo)

    enviar_email('soetestes+2@outlook.com', 'New! Novos preços encontrados', 'Novo!!! Confira os novos preços', caminho_arquivo)
